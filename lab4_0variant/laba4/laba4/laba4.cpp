// laba4.cpp : Defines the entry point for the application.
//
    ...
    case WM_PAINT:
        {
            ...
            hFont = CreateFont(30, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, DEFAULT_CHARSET,
                OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY,
                DEFAULT_PITCH | FF_DONTCARE, L"New Roman");

            
            hFontOld = (HFONT)SelectObject(hdc, hFont);

            
            TextOut(hdc, 300, 150, str.c_str(), str.length());
...
INT_PTR CALLBACK dialog1(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        ...
        case IDC_yesBUTTON:
        {
            ...
            GetDlgItemText(hDlg, IDC_EDITFIELD, buffer, MAX_PATH);
            str = buffer; 
            EndDialog(hDlg, LOWORD(wParam));
            return (INT_PTR)TRUE;
        }
